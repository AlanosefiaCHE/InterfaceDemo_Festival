...
namespace MyApp 
{
    internal class Program
    {
        static async Task Main(string[] args)
        {
            ...
            var hamburgerTent = new HamburgerTent() { Locatie = "B5", Omschrijving = "Bens Burgers", Begin = dinsdagVan8, End = dinsdagTot12 };
            var sushiTent = new SushiTest() { Locatie = "F16", Omschrijving = "Sans sushi", Begin = dinsdagVan8, End = dinsdagTot12 };
